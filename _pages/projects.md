...
- Each action of a character on the board is recorded in the text box (implemented using <span style="color:yellow">Observer Pattern</span>)
...
- The daily actions of the store staff are recorded in the logger file(created using <span style="color:yellow">Observer Pattern</span>)
